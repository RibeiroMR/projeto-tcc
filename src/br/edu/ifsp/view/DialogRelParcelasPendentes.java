 ...
 * @author Murilo
 */
public class DialogRelParcelasPendentes extends javax.swing.JDialog {

    /**
     * Creates new form DialogRelParcelasPendenrtes
     */
    public DialogRelParcelasPendentes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Informe o Período que foi gerado as Parcelas!");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (dateDataMin.getDate() == null || dateDataMax.getDate() == null) {
            ...
            try {
                JasperReport relCompilado = JasperCompileManager.compileReport("src/br/edu/ifsp/rel/RelatorioParcelasAtrasadas.jrxml");

                Map parametros = new HashMap();

                parametros.put("REPORT_CONNECTION", "src/br/edu/ifsp/rel/DadosParcelas.jrxml");
                parametros.put("dataMinima", dateDataMin.getDate());
                parametros.put("dataMaxima", dateDataMax.getDate());

                JasperPrint relPreenchido = JasperFillManager.fillReport(relCompilado, parametros, Conexao.abrir());

                JFrame tela = new JFrame("Relatório de parcelas pendentes/atrasadas!");
                ...
                Logger.getLogger(DialogRelParcelasPendentes.class.getName()).log(Level.SEVERE, null, ex);
                JOptionPane.showMessageDialog(this, "Erro ao gerar Relatório de Parcelas");
            }
            this.dispose();
        }
